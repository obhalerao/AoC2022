...
for idx, ls in enumerate(lines):
    ...
    while q:
        ...
        if (time, ore_bots, ore, clay_bots, clay, obs_bots, obs, geo_bots) in seen and seen[(time, ore_bots, ore, clay_bots, clay, obs_bots, obs, geo_bots)] >= geo:
            continue

        seen[(time, ore_bots, ore, clay_bots, clay, obs_bots, obs, geo_bots)] = geo
